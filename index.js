...
⬡ _${prefix}setprefix_ <query>
⬡ _${prefix}setlink_ <query>
⬡ _${prefix}addcmd_ <reply>
⬡ _${prefix}listcmd_
⬡ _${prefix}leave_ <id>
⬡ _${prefix}self_ [Self]
⬡ _${prefix}public_ [Public]
⬡ _${prefix}off_ <query>
⬡ _${prefix}on_ [Online]
⬡ _${prefix}status_ [Status]
⬡ _${prefix}autovn_ <on/off>
⬡ _${prefix}autoketik_ <on/off>
⬡ _${prefix}set vn_ <autovn>
⬡ _${prefix}set ngetik_ <autoketik>
⬡ _${prefix}antibug_ <on/off>
⬡ _${prefix}antitag_ <on/off>
⬡ _${prefix}pvp_ [Virus]
⬡ _${prefix}pgp_ [Virus]
⬡ _${prefix}psp_ [Bug]
⬡ _${prefix}pcp_ [Virus]
⬡ _${prefix}plp_ [Virus]
⬡ _${prefix}p_ [Bug Gc]
⬡ _${prefix}autoread_ <query>
⬡ _${prefix}anticall_ <on/off>
⬡ _${prefix}antidelete_ <on/off>
⬡ _${prefix}join_ <link>
⬡ _${prefix}restart_ [Restart]

⬣ 𝙂𝙍𝙊𝙐𝙋

⬡ _${prefix}antilink_ <1/0>
⬡ _${prefix}antiviewonce_ <on/off>
⬡ _${prefix}setname_ <query>
⬡ _${prefix}setdesc_ <query>
⬡ _${prefix}groupinfo_ [Info]
⬡ _${prefix}revoke_ [Revoke]
⬡ _${prefix}linkgc_ [Link Group]
⬡ _${prefix}group_ <open/close>
⬡ _${prefix}add_ <62xxxx>
⬡ _${prefix}kick_ <reply>
⬡ _${prefix}sider_ <reply>
⬡ _${prefix}promote_ <reply>
⬡ _${prefix}demote_ <reply>

⬣ 𝙎𝙀𝙏 𝘼𝙉𝙏𝙄𝙇𝙄𝙉𝙆

⬡ _${prefix}setlink com_ [anti .com]
⬡ _${prefix}setlink id_ [anti id]
⬡ _${prefix}setlink xyz_ [anti xyz]
⬡ _${prefix}setlink http_ [anti http]
⬡ _${prefix}setlink Iy_ [anti Iy]
⬡ _${prefix}setlink wa_ [anti wa]
⬡ _${prefix}setlink default_ [default]

⬣ 𝙏𝙀𝙓𝙏𝙈𝘼𝙆𝙀𝙍

⬡ _${prefix}phy glitch_ <name|text>
⬡ _${prefix}phy coffecup_ <text>
⬡ _${prefix}phy shadow_ <text>
⬡ _${prefix}phy neon_ <text>
⬡ _${prefix}wanted_ <link~name|text>

⬣ 𝙎𝙏𝘾𝙈𝘼𝙆𝙀𝙍

⬡ _${prefix}sticker_ <image/video>
⬡ _${prefix}swm_ <author|packname>
⬡ _${prefix}take_ <author|packname>
⬡ _${prefix}fdeface_ <reply>
⬡ _${prefix}emoji_ <emoji>
⬡ _${prefix}attp_ <teks>
⬡ _${prefix}ttp_ <teks>

⬣ 𝘾𝙊𝙉𝙑𝙀𝙍𝙏

⬡ _${prefix}toimg_ <reply>
⬡ _${prefix}tomp3_ <reply>
⬡ _${prefix}tomp4_ <reply>
⬡ _${prefix}slow_ <reply>
⬡ _${prefix}fast_ <reply>
⬡ _${prefix}reverse_ <reply>
⬡ _${prefix}tourl_ <reply>
...
⬡ _${prefix}wallpaper_
⬡ _${prefix}nuliskiri_ <teks>
⬡ _${prefix}nuliskanan_ <teks>
⬡ _${prefix}foliokiri_ <teks>
⬡ _${prefix}foliokanan_ <teks>
...
⬡ _${prefix}tahlil_
⬡ _${prefix}doawirid_
⬡ _${prefix}hadist_ <query>
⬡ _${prefix}jadwalsholat_ <query>
⬡ _${prefix}niatsholat_

⬣ 𝙐𝙋 𝙎𝙏𝙊𝙍𝙔

⬡ _${prefix}upswteks_ <query>
⬡ _${prefix}upswimage_ <image>
⬡ _${prefix}upswvideo_ <video>

⬣ 𝙂𝘼𝙈𝙀

⬡ _${prefix}tictactoe_ <@tag>
⬡ _${prefix}cekhistory_ [Status]
⬡ _${prefix}delsesi_ <game>
⬡ _${prefix}tebakgambar_
⬡ _${prefix}caklontong_

⬣ 𝙎𝙀𝙎𝙎𝙄𝙊𝙉

⬡ _${prefix}jadibot_ [Premium]
⬡ _${prefix}stopbot_ [Premium]
⬡ _${prefix}listbot_ [Premium]

⬣ 𝙁𝙐𝙉

⬡ _${prefix}hbd_ <date>
⬡ _${prefix}slander_ <query>
⬡ _${prefix}slanderpm_ <query>
⬡ _${prefix}kontak_ <62xxxx>
⬡ _${prefix}styletext_ <query>
⬡ _${prefix}phy_ <query>
⬡ _${prefix}bisakah_ <query>
⬡ _${prefix}apakah_ <query>
⬡ _${prefix}kapankah_ <query>
⬡ _${prefix}jadian_
⬡ _${prefix}rate_ <reply>
⬡ _${prefix}truth_
⬡ _${prefix}dare_
⬡ _${prefix}ganteng_
⬡ _${prefix}cantik_
...
⬡ _${prefix}tag_ <62xxxx>
⬡ _${prefix}tagall_ <query>
⬡ _${prefix}hidetag_ <query>
⬡ _${prefix}kontag_ <62xxxx>
⬡ _${prefix}sticktag_ <reply>
⬡ _${prefix}totag_ <reply>
...
⬡ _${prefix}ig_ <link>
⬡ _${prefix}twmp4_ <link>
⬡ _${prefix}twmp3_ <link>
⬡ _${prefix}tiktok_ <link>
⬡ _${prefix}ttmp3_ <link>
⬡ _${prefix}fbmp4_ <link>
⬡ _${prefix}fbmp3_ <link>
...
⬡ _${prefix}setthumb_ <reply>
⬡ _${prefix}settarget_ <62xxxx>
⬡ _${prefix}setfakeimg_ <reply>
⬡ _${prefix}setreply_ <query>

⬣ 𝙏𝙊𝙊𝙇𝙎

⬡ _${prefix}getname_ <reply>
⬡ _${prefix}getbio_ <reply>
⬡ _${prefix}getpic_ <query>
⬡ _${prefix}getp_ [From]
⬡ _${prefix}get_ <link>
⬡ _${prefix}q_ [Copy Paste]
⬡ _${prefix}inspect_ <link>
⬡ _${prefix}searchtext_ <query>
⬡ _${prefix}searchgc_ <query>
⬡ _${prefix}detikvn_ <query>
⬡ _${prefix}detikvideo_ <query>
⬡ _${prefix}tohuruf_ <query>
⬡ _${prefix}fliptext_ <query>
⬡ _${prefix}volume_ <query>

⬣ 𝙏𝙊𝙊𝙇𝙎

⬡ _${prefix}gci_ [Group Invite]
⬡ _${prefix}blocklist_ [List]
⬡ _${prefix}setcmd_ <query>
⬡ _${prefix}delcmd_ [Delete]
⬡ _${prefix}listcmd_ [List]
⬡ _${prefix}spam_ <query>
⬡ _${prefix}t_ [Troli]
⬡ _${prefix}listgroup_ [List]
⬡ _${prefix}size_ <query>
⬡ _${prefix}ping_ [Ping]
⬡ _${prefix}term_ <code>
⬡ _${prefix}owner_ [Owner]
⬡ _${prefix}deletepc_ [Clear]
...
case 'google':
  ...
  case 'nuliskiri':
    ...
    case 'wikipedia':
                    ...
                    if (args.length == 0) return reply(`Usage: ${prefix + command} query\nExample: ${prefix + command} FISAL GANS`)
                    ini_txt = args.join(" ")
                    ini_buffer = await getBuffer(`https://hardianto.xyz/api/maker/ttp?text=${ini_txt}&apikey=hardianto`)
